...
var ct2FeedbackController =angular.module('contact2FeedbackController',[]);

ct2FeedbackController.controller('feedbacksPostCtrl',['$scope','feedbacksMainService',function($scope,feedbacksMainService){
	$scope.submit=function()
	{
		var feedback=JSON.stringyfy({description:$scope.description});
		feedbacksMainService.CreateFeedback.save(feedback);
	};
		COMMON.showGlobalMessageAlert("thanks");
